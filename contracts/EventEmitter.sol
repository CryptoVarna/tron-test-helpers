...
contract EventEmitter {
    ...
    event IndexedConflictingUint(
        uint256 indexed indexedValue1,
        uint256 normalValue1
    );
    ...
    constructor(
        ...
        string[] memory stringArrayValue
    ) {
    ...
    function emitStringAndEmitIndirectly(
        string memory value,
        IndirectEventEmitter emitter
    ) public {
        emit String(value);
    ...
    function emitIndexedUintAndEmitIndirectly(
        uint256 indexedValue,
        uint256 normalValue,
        uint256 indexedValue2,
        uint256 normalValue2,
        IndirectEventEmitter emitter
    ) public {
        emit IndexedUint(indexedValue, normalValue);
    ...
    function emitIndexedConflictingUint(
        uint256 indexedValue1,
        uint256 normalValue1,
        uint256 indexedValue2,
        uint256 indexedValue3,
        IndirectEventEmitter emitter
    ) public {
